...
namespace cd.Model {
	...
	public partial class Tb_topic111333Info {
		#region fields
		private int? _Id;
		private int? _Clicks;
		...
		public Tb_topic111333Info() { }

		#region 序列化，反序列化
		protected static readonly string StringifySplit = "@<Tb_topic111333(Info]?#>";
		...
		public static Tb_topic111333Info Parse(string stringify) {
			...
			if (ret.Length != 5) throw new Exception($"格式不正确，Tb_topic111333Info：{stringify}");
		...
		private static Lazy<Dictionary<string, bool>> __jsonIgnoreLazy = new Lazy<Dictionary<string, bool>>(() => {
			FieldInfo field = typeof(Tb_topic111333Info).GetField("JsonIgnore");
		...
		public cd.DAL.Tb_topic111333.SqlUpdateBuild UpdateDiy => _Id == null ? null : BLL.Tb_topic111333.UpdateDiy(new List<Tb_topic111333Info> { this });

		#region sync methods

		public Tb_topic111333Info Save() {
			if (this.Id != null) {
				if (BLL.Tb_topic111333.Update(this) == 0) return BLL.Tb_topic111333.Insert(this);
				return this;
			}
			return BLL.Tb_topic111333.Insert(this);
		}
		#endregion

		#region async methods

		async public Task<Tb_topic111333Info> SaveAsync() {
			if (this.Id != null) {
				if (await BLL.Tb_topic111333.UpdateAsync(this) == 0) return await BLL.Tb_topic111333.InsertAsync(this);
				return this;
			}
			return await BLL.Tb_topic111333.InsertAsync(this);
		}
		#endregion
	}
}
